...
df = pd.read_csv(r'C:\Users\ferri\Downloads\y2kelsey.csv', usecols=["Track Name", "Artist Name(s)",
                                                                    "Release Date", "Genres"]) #the file, and columns we're usin
...
topten = Button(window, text="Top 10 Artists", bg='Black', fg='lightgreen', font="helvetica 16 bold", width="25",
                    command=artists).place(x=90, y=100) #the button, calling back to the command
...
years = Button(window, text ="Songs ♥ by release year", bg="black", fg='lightgreen', font= "helvetica 16 bold", width="25", command=years).place(x=90,y=150)
#command button
...
genres = Button(window, text ="Top 5 Genres", bg="black", fg='lightgreen', font= "helvetica 16 bold", width="25", command=genres).place(x=90,y=200)
#the button
